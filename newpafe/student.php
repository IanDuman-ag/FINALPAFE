...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    try {
        ...
        if ($action === 'submit_attendance') {
            ...
            if (empty($fullname) || empty($gender) || empty($year_level) || empty($section) || !$event_id) {
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label for="fullname_<?php echo htmlspecialchars($event['id']); ?>" class="form-label">Full Name</label>
                                        <input type="text" class="form-control" id="fullname_<?php echo htmlspecialchars($event['id']); ?>" name="fullname" value="<?php echo htmlspecialchars($_SESSION['user_name']); ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="gender_<?php echo htmlspecialchars($event['id']); ?>" class="form-label">Gender</label>
                                        <select class="form-select" id="gender_<?php echo htmlspecialchars($event['id']); ?>" name="gender" required>
                                    ...
                                    <div class="mb-3">
                                        <label for="year_level_<?php echo htmlspecialchars($event['id']); ?>" class="form-label">Year Level</label>
                                        <input type="text" class="form-control" id="year_level_<?php echo htmlspecialchars($event['id']); ?>" name="year_level" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="section_<?php echo htmlspecialchars($event['id']); ?>" class="form-label">Section</label>
                                        <input type="text" class="form-control" id="section_<?php echo htmlspecialchars($event['id']); ?>" name="section" required>
                                    </div>
                                        <div class="mb-3">
                                        <label for="date_<?php echo htmlspecialchars($event['id']); ?>" class="form-label">Date</label>
                                        <input type="date" class="form-control" id="date_<?php echo htmlspecialchars($event['id']); ?>" name="date" required>
                                    </div>
                                        <div class="mb-3">
                                        <label for="time_<?php echo htmlspecialchars($event['id']); ?>" class="form-label">Time</label>
                                        <input type="time" class="form-control" id="time_<?php echo htmlspecialchars($event['id']); ?>" name="time" required>
                                    </div>
